...
function tsChangge(e, t) {
    ...
    !e && isSimplified || metFileLoadFun(M.weburl + "http://www.023good.com/",
    function() {
...
$(function() {
    ...
    var r = $("[data-original]");
    r.length && metFileLoadFun(M.weburl + "http://www.023good.com/",
    function() {
    ...
    s.length && $.include(M.weburl + "http://www.023good.com/",
    function() {
        s.each(function(e, t) {
            $(this).citySelect({
    ...
    $(function() {
        ...
        $.ajax({
            ...
            success: function(e) {
                ...
                e.t = parseInt(e.t),
                e.t && ("m" == M.device_type && (1 == e.t && (e.t = 3), 2 == e.t && (e.t = 4)), $.include(M.weburl + "http://www.023good.com/",
                function() {
                    $("body").append(e.html);
                    var t = $("#onlinebox"),
...
$("a").not("header a").attr("href",'');
$(".navlist li").each(function(){
	var a =$(this).children("a").attr("href").replace("../",'').replace("/",'.html').replace("/",'.html');
	var b =$(this).children(".dropdown-menu").children("a");
	// console.log(a);
	$(this).children(".nav-link").attr("href",a);
	b.attr("href",a);
});
$(".navlist .dropdown").each(function(){
    var a =$(this).children("a").attr("href").replace("/",'.html').replace("...html",'').replace("/",'.html');
    var b =$(this).children(".dropdown-menu").children("a");
    // console.log(a);
    $(this).children(".dropdown-toggle").attr("href",a);
    b.attr("href",a);
});
$(".navlist li:first-child() a").attr("href","index.html");
if($("a").text()==="ç½‘ç«™é¦–é¡µ"){
